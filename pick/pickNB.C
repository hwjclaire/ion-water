...
int main (int argc, char *argv[])
{
  ...
  {
    cout << "USAGE:\n";
    cout << "pickNB.x [input xyz] [input mlwf] [input polariz]  #frame nMO nskip\n";
    return 1;
  }
      ...
      for ( int iwater = 0; iwater < waterset.size(); iwater ++ )
      {
        ...
        for ( int jwater = 0; jwater < waterset.size(); jwater ++ )
        {
          ...
          if ( d_oo < thresh1 )
          {
            ...
            {
              if ( oh[ioh] * oo > thresh2 ) hb[ioh] = true;
              //cout << oh[ioh] * oo << "   ";
            }
          }
          //cout << endl;
        ...
        for ( int ioh = 0; ioh < 2; ioh ++ )
        {
          if ( hb[ioh] == 1 && hb[(ioh+1)%2] == 0 )//this BP OH is Hbonded while the other is not
          //if ( hb[(ioh+1)%2] == 0 )//the other BP is not Hbonded
        ...
        polarmlwfaxis [ iwater * 2 + 1 ] 
                          << setw(8) << waterset[iwater].wf(1)->polar_tensor()[0]
                          << setw(8) << waterset[iwater].wf(1)->polar_tensor()[4]
                          << setw(8) << waterset[iwater].wf(1)->polar_tensor()[8]
                          << setw(8) << waterset[iwater].wf(1)->polar_tensor()[1]
                          << setw(8) << waterset[iwater].wf(1)->polar_tensor()[2]
                          << setw(8) << waterset[iwater].wf(1)->polar_tensor()[5]
                          << setw(8) << waterset[iwater].wf(1)->polar_tensor()[3]
                          << setw(8) << waterset[iwater].wf(1)->polar_tensor()[6]
                          << setw(8) << waterset[iwater].wf(1)->polar_tensor()[7]
                          << endl;
#else
        if ( hb[0] and hb[1] )
        {
