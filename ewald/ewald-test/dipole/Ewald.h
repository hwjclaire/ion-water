...
class Ewald
{
  ...
  double kappa_, kappa2_, kappa3_, fourkappa2_;//std dev of cancelling Gaussian charge
  ...
  std::vector < D3vector > ionpolar_; // polarization of ions

  std::vector < D3vector > ionfield_short_; // short range potential of ions

  std::vector < D3vector > ionfield_long_; // long range potential of ions

  std::vector < D3vector > ionfield_self_; // self potential of ions
