...
int main (int argc, char *argv[])
{
  ...
  {
    cout << "USAGE:\n";
    cout << "testPolariz.x [input xyz] [input mlwf] [input polariz]  #frame nMO nskip nskip2\n";
    return 1;
  }
  ...
  ofstream alphamolaxis[nmo/4];
  ofstream alphamol[nmo/4];
  ofstream polarmol[nmo/4];
  ofstream polarmolaxis[nmo/4];
  ofstream dipolemol[nmo/4];
