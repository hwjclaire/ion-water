// output-water-dist-polar.x
// For simulation of bulk water/ice
// output water and its neiborghs using spherical coordinate 
...
int main (int argc, char *argv[])
{
  ...
  {
    cout << "USAGE:\n";
    cout << "output-water-dist-polar.x [input xyz] [input mlwf] [input quadrupole] [input polar] #frame nwater nskip\n";
    return 1;
  }
    ...
    if ( nskip == 0 || iframe % nskip == 0 )
    {
      ...
      for ( int i = 0; i < waterset.size(); i ++ )
      {
        ...
        for ( DistMap::iterator j = dmap.begin(); j != dmap.end(); j ++ )
        {
          ...
          {
            ofwater << polar(v0rot) << " ";
            ofwater << ( r1 < r2 ? polar(v1rot) : polar(v2rot) ) << " " << ( r1 < r2 ? polar(v2rot) : polar(v1rot) ) << " ";
          }

          if ( i == 0 )
          {
            ofwater1 << polar(v0rot) << " ";
            ofwater1 << ( r1 < r2 ? polar(v1rot) : polar(v2rot) ) << " " << ( r1 < r2 ? polar(v2rot) : polar(v1rot) ) << " ";
          }
        ...
        if ( iframe % 100 == 0 )
        {
          ...
          ofwater << iwater->alpha_tensor_axis(5) << " ";
          ...
          ofwater << iwater->polar_tensor_axis(5) << " ";
        ...
        if ( i == 0 ) 
        {
          ...
          ofwater1 << iwater->alpha_tensor_axis(5) << " ";
          ...
          ofwater1 << iwater->polar_tensor_axis(5) << " ";
