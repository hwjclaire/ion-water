...
// output polarizability of each wannier center.
// Quan (Andy) Wan Tue Dec 11 13:23:39 PST 2012
...
int main (int argc, char *argv[])
{
  ...
  {
    cout << "USAGE:\n";
    cout << "output.x [input xyz] [input mlwf] [input polariz]  #frame nMO nskip nskip2\n";
    return 1;
  }
  ...
  ofstream polarmlwf[nmo];


  for ( int imlwf = 0; imlwf < 4; imlwf ++ )
  {
    fxyz.seekg(ios_base::beg);
    fmlwf.seekg(ios_base::beg);
    fpolar.seekg(ios_base::beg);
    ...
    for ( int iframe = 0; iframe < nframe; iframe ++)
    {
      ...
      //assign H to O
      if ( iframe == 0 && imlwf == 0 )  //assign molecules 
      {
      ...
      if ( nskip == 0 || iframe % nskip == 0 )
      {
        ...
        for ( int iwater = 0; iwater < waterset.size(); iwater ++ )
        {
          ...
          polarmlwf [ iwater * 4 + imlwf ] 
                            << setw(8) << waterset[iwater].wf(imlwf)->polar_tensor()[0]
                            << setw(8) << waterset[iwater].wf(imlwf)->polar_tensor()[4]
                            << setw(8) << waterset[iwater].wf(imlwf)->polar_tensor()[8]
                            << setw(8) << waterset[iwater].wf(imlwf)->polar_tensor()[1]
                            << setw(8) << waterset[iwater].wf(imlwf)->polar_tensor()[2]
                            << setw(8) << waterset[iwater].wf(imlwf)->polar_tensor()[5]
                            << setw(8) << waterset[iwater].wf(imlwf)->polar_tensor()[3]
                            << setw(8) << waterset[iwater].wf(imlwf)->polar_tensor()[6]
                            << setw(8) << waterset[iwater].wf(imlwf)->polar_tensor()[7]
                            << endl;
