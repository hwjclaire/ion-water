...
// output the velocity of oxygens
// Quan (Andy) Wan Sun Mar 10 17:34:10 PDT 2013
...
int main (int argc, char *argv[])
{
  ...
  {
    cout << "USAGE:\n";
    cout << "output-vel.x [input xyz] [NULL] [NULL]  #frame [NULL] nskip1 [NULL] nwater\n";
    return 1;
  }
  ...
  for ( int iframe = 0; iframe < nframe; iframe ++)
  {
    ...
    if ( iframe % nskip1 == 0 ) 
      for ( int iwater = 0; iwater < waterset.size(); iwater ++ )
        polarmlwf [ iwater ] <<  waterset[iwater].o()->x() << endl;
