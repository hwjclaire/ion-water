...
// output sum of squared MLWF spread of all waters
...
int main (int argc, char *argv[])
{
  ...
  {
    cout << "USAGE:\n";
    cout << "output-spread.x [input xyz] [input mlwf] [input polariz]  #frame nMO nskip1 nskip2 nwater\n";
    return 1;
  }
  ...
  ofstream fstatspread;
  fstatspread.open("spread.stat");
  ...
  for ( int iframe = 0; iframe < nframe; iframe ++)
  {
    ...
    if ( nskip1 == 0 || iframe % nskip1 == 0 )
    {
      ...
      for ( int iwater = 0; iwater < waterset.size(); iwater ++ )
      {
        ...
        {
          statspread.add(waterset[iwater].wf(imlwf)->spread());
          polarmlwf [ iwater ] << setw(12) << 
                waterset[iwater].wf(imlwf)->spread2();
        }

        polarmlwf [ iwater ] << setw(12) << 
                waterset[iwater].wf(0)->spread2()
              + waterset[iwater].wf(1)->spread2();

        polarmlwf [ iwater ] << setw(12) <<  
                waterset[iwater].wf(2)->spread2()
              + waterset[iwater].wf(3)->spread2();
